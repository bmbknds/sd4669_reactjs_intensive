    ...
    <Layout className="landing-page">
      <Header className="landing-header">
        <div className="header-content">
          <div className="logo-section">
            ...
            <Title level={5} className="site-title">
              Simple KYC
            </Title>
          </div>
      ...
      <Content className="landing-content">
        <div className="welcome-section">
          <Title level={2}>
            Welcome back, {user?.personalInfo?.firstName || user?.name}
          </Title>
          ...
          <Col xs={24} lg={8}>
            <Card title="Need Help?" className="info-card help-card">
              <div className="help-content">
                <Text>
                  If you have any questions or need assistance with the KYC process, please
                  contact our support team.
                </Text>
                <Button type="primary" block className="help-button">
                  Contact Support
                </Button>
              </div>
            </Card>
      ...
      <Footer className="landing-footer">
        <div className="footer-content">
          ...
          <Text type="secondary" className="copyright">
            © 2025-2026 KYCAuthentication.com. All rights reserved.
          </Text>
        </div>
      </Footer>
    </Layout>
